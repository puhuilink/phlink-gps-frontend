<template>
    <el-container v-loading="isView" class="fm2-container" :class="{ 'view-mode': isView }">
        ...
        <el-footer height="30px" style="font-weight: 600;">
            Powered by <a target="_blank" href="">phlink</a>
        </el-footer>
...
<script>
    ...
    import {queryDictItemByDictCode, queryDictItemByDictCodes} from '@/api/dict'
    ...
    export default {
        ...
        mounted() {
                queryDictItemByDictCodes({dictCodes: 'processCategory,taskCategory'}).then(({data}) => {
                    this.processCategory = data.data['processCategory']
