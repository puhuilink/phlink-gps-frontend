        ...
        >
            ...
            <el-table-column label="授权类型" prop="identityType" align="center">
                <template slot-scope="scope">
                    <span v-html="myFormatDictText(dicts.identityType,scope.row.identityType)"></span>
                </template>
            </el-table-column>
                ...
                <template slot-scope="{row}">
                    <el-dropdown>
                        ...
                        <el-dropdown-menu slot="dropdown">
                            ...
                            <el-dropdown-item icon="el-icon-delete" divided @click.native="btnDelete(row)">删除
                            </el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </template>
...
<script>
    import {list, saveLink, deleteLink} from '@/api/flowable-defIdentityLink'
    ...
    export default {
        ...
        created() {
            // TODO identityType
            queryDictItemByDictCode('identityType').then(({data}) => {
