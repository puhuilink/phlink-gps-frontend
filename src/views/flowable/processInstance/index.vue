    ...
    <div class="app-container">
        ...
        <el-dialog title="流程实例" :visible.sync="dialogFormVisible">
            ...
            <div slot="footer" class="dialog-footer">
                <el-button v-if="temp.endTime==null"
                           icon="el-icon-check"
...
<script>
    import {list, queryById, deletePro} from '@/api/flowable-process'
    ...
    export default {
        ...
        methods: {
            ...
            btnViewProcessInstance(row) {
                queryById({processInstanceId: row.id}).then(res => {
                    const {data} = res.data
            ...
            btnSuspendOrActivate(processInstanceId, suspend) {
                ...
                updatePro(suspendOrActivate, {processInstanceId: processInstanceId}).then(({msg}) => {
                    this.$message({
                        type: 'success',
                        message: msg
                    })
