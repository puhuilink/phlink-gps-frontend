<template>
    <div class="app-container">
        ...
        <el-row>
            <el-col :span="12" v-for="row in myInvolvedRecords" :key="row.id">
                    ...
                    <el-card>
                        ...
                        <div style="height: 110px;padding-left: 15px">
                            <el-scrollbar class="scroll-container">
                                <router-link v-for="(item) in row.processDefinitionVoList"
...
<script>
    import {listMyInvolvedSummary} from '@/api/flowable-process'
    ...
    export default {
        ...
        methods: {
            list() {
                listMyInvolvedSummary(this.listQuery).then(res => {
                    // TODO 有id？
                    const {data} = res.data
